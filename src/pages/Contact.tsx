                        ...
                        <div className="contact-info reveal">
                            ...
                            <div className="contact-item">
                                ...
                                <div className="contact-details">
                                    <h4>Our Location</h4>
                                    <p>
                                        {BUSINESS_INFO.address.street}, {BUSINESS_INFO.address.suite}<br />
                            ...
                            <div className="contact-item" style={{ marginBottom: 0 }}>
                                ...
                                <div className="contact-details">
                                    ...
                                    <p>
                                        {BUSINESS_INFO.hours.weekday.days}: {BUSINESS_INFO.hours.weekday.hours}<br />
                                        {BUSINESS_INFO.hours.saturday.days}-{BUSINESS_INFO.hours.sunday.days}: {BUSINESS_INFO.hours.saturday.hours}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="contact-form-wrapper reveal">
                            ...
                            {submitted ? (
                                <div className="text-center" style={{ padding: 'var(--space-2xl) 0' }}>
                                    <div style={{ fontSize: '5rem', color: 'var(--color-primary)', marginBottom: 'var(--space-md)' }}>
                                        <i className="fas fa-check-circle"></i>
                                    </div>
                                    <h4 style={{ fontSize: 'var(--text-2xl)', marginBottom: 'var(--space-sm)' }}>Booking Requested</h4>
                                    <p style={{ color: 'var(--color-text-light)' }}>
                                        Thank you, {formData.name.split(' ')[0]}! Our concierge will contact you shortly at {formData.email} to confirm your preferred session.
                                    </p>
                                    <button
                                ...
                                <form className="contact-form" onSubmit={handleSubmit}>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="message">Special Preferences</label>
                                        <textarea
                                            id="message"
                                            name="message"
                                            rows={4}
                                            ...
                                            onChange={handleChange}
                                            placeholder="Tell us about any specific details or preferences for your visit..."
                                        ></textarea>
                                    </div>
